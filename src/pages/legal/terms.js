...
const TermsPage = ({ location }) => (
  <Layout location={location}>
    ...
    <Container>
      <h2>Welcome to Japan Life Stories</h2>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Japan Life Stories's Website.
      </p>{" "}
      <br />
      ...
      <p>
        ...
        conditions in full. Do not continue to use Japan Life Stories's website
      ...
      <p>
        ...
        prevailing law of France. Any use of the above terminology or other
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Japan Life Stories's website you
        consent to the use of cookies in accordance with Japan Life Stories's
        privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Japan Life Stories and/or it's licensors own
        the intellectual property rights for all material on Japan Life Stories.
        All intellectual property rights are reserved. You may view and/or print
        pages from https://japanlifestories.com for your own personal use
        subject to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://japanlifestories.com</li>
        <li>
          Sell, rent or sub-license material from https://japanlifestories.com
        </li>
        <li>
      ...
      <p>
        Redistribute content from Japan Life Stories (unless content is
      ...
      <ol>
        ...
        <li>
          ...
          areas of the website. Japan Life Stories does not screen, edit,
          publish or review Comments prior to their appearance on the website
          and Comments do not reflect the views or opinions ofJapan Life
          Stories, its agents or affiliates. Comments reflect the view and
          opinion of the person who posts such view or opinion. To the extent
          permitted by applicable laws Japan Life Storiesshall not be
        ...
        <li>
          Japan Life Storiesreserves the right to monitor all Comments and to
        ...
        <li>
          You hereby grant to <strong>Japan Life Stories</strong> a
      ...
      <p>
        ...
        Japan Life Stories; and (d) where the link is in the context of general
      ...
      <p>
        ...
        <a
          ...
          title="send an email to paul@japanlifestories.com"
        >
      ...
      <p>
        No use of Japan Life Stories's logo or other artwork will be allowed for
