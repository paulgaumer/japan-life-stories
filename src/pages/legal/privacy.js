  ...
  <Layout location={location}>
    ...
    <Container>
      ...
      <address>
        Japan Life Stories
        <br />
        31 bd charles detriche Angers <br />
        49000 , France
        <br />
      </address>
      <p>
        It is Japan Life Stories's policy to respect your privacy regarding any
        ...
        >
          https://japanlifestories.com
        </a>{" "}
        (hereinafter, "us", "we", or "https://japanlifestories.com"). We respect
      ...
      <p>
        Like most website operators, Japan Life Stories collects
        ...
        request. Japan Life Stories's purpose in collecting non-personally
        identifying information is to better understand how Japan Life Stories's
        visitors use its website. From time to time, Japan Life Stories may
      ...
      <p>
        Japan Life Stories also collects potentially personally-identifying
        information like Internet Protocol (IP) addresses for logged in users
        and for users leaving comments on https://japanlifestories.com blog
        posts. Japan Life Stories only discloses logged in user and commenter IP
        addresses under the same circumstances that it uses and discloses
        personally-identifying information as described below.
      </p>
      <h2>Gathering of Personally-Identifying Information</h2>
      <p>
        Certain visitors to Japan Life Stories's websites choose to interact
        with Japan Life Stories in ways that require Japan Life Stories to
        gather personally-identifying information. The amount and type of
        information that Japan Life Stories gathers depends on the nature of the
        interaction. For example, we ask visitors who sign up for a blog at
        https://japanlifestories.com to provide a username and email address.
      </p>
      <h2>Security</h2>
      <p>
      ...
      <p>
        ...
        Privacy Policy covers the use of cookies by Japan Life Stories and does
      ...
      <h2>Https://japanlifestories.com uses Google AdWords for remarketing</h2>
      <p>
        Https://japanlifestories.com uses the remarketing services to advertise
      ...
      <p>
        Japan Life Stories may collect statistics about the behavior of visitors
        to its website. Japan Life Stories may display this information publicly
        or provide it to others. However, Japan Life Stories does not disclose
      ...
      <h2>Cookies</h2>
      <p>
        To enrich and perfect your online experience, Japan Life Stories uses
      ...
      <p>
        ...
        time the visitor returns. Japan Life Stories uses cookies to help Japan
        Life Stories identify and track visitors, their usage of
        https://japanlifestories.com, and their website access preferences.
        Japan Life Stories visitors who do not wish to have cookies placed on
        their computers should set their browsers to refuse cookies before using
        Japan Life Stories's websites, with the drawback that certain features
        of Japan Life Stories's websites may not function properly without the
        aid of cookies.
      </p>
      <p>
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to Japan Life Stories's use
        of cookies.
      </p>
      <h2>Privacy Policy Changes</h2>
      <p>
        Although most changes are likely to be minor, Japan Life Stories may
        change its Privacy Policy from time to time, and in Japan Life Stories's
        sole discretion. Japan Life Stories encourages visitors to frequently
      ...
      <p>
        ...
        via{" "}
        <a
          href="mailto:paul@japanlifestories.com"
          target="_blank"
          rel="noopener noreferrer"
        >
          email.
